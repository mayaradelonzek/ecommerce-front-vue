    ...
    <b-row align-h="center">
      <b-col md="6">
        <b-form-group label="Nome fantasia">
          <b-form-input :state="nomeFantasia.validation" type="text" class="mb-3" v-model="nomeFantasia.valor" />
        </b-form-group>
      </b-col>
    </b-row>
    ...
    <b-row align-h="center">
      <b-col md="3">
        <b-form-group label="CNPJ">
          <b-form-input :state="cnpj.validation" type="text" class="mb-3" v-model="cnpj.valor"/>
        </b-form-group>
      </b-col>
      <b-col md="3">
...
export default {
  ...
  methods: {
    createFornecedor: async function () {
      const newFornecedor = {        
        nomeFantasia: this.nomeFantasia.valor,
        cnpj: this.cnpj.valor,
        contato: {
      ...
      let isError = [];      
      this.nomeFantasia.validation = this.isValidate(this.nomeFantasia.valor, isError);
      this.cnpj.validation = this.isValidate(this.cnpj.valor, isError);
      ...
      if (!result.error) {              
        this.nomeFantasia = {valor: "", validation: null};
